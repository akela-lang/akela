...
rm -rf cmake-build-debug &&
    ...
    for name in zinc-test akela-test akela-llvm-test dataframe-test cobble-test json-test
    do
    ...
    cd $coverage_dir &&
    for name in zinc zinc-test akela akela-test akela-llvm akela-llvm-test dataframe dataframe-test cobble cobble-test json json-test
    do
        mkdir -p $name &&
        cd $name &&
