...
void test_parse_number_integer()
{
	...
	struct ast_node* num = ast_get_child(root, 0);
...
void test_parse_number_float()
{
	...
	struct ast_node* number = ast_get_child(root, 0);
...
void test_parse_string()
{
	...
	struct ast_node* string = ast_get_child(root, 0);
...
void test_parse_boolean_true()
{
	...
	struct ast_node* true_node = ast_get_child(root, 0);
...
void test_parse_boolean_false()
{
	...
	struct ast_node* false_node = ast_get_child(root, 0);
...
void test_parse_id()
{
	...
	struct ast_node* id = ast_get_child(root, 1);
...
void test_parse_anonymous_function()
{
	...
	struct ast_node* param1 = ast_get_child(type_dseq, 1);
	...
	struct ast_node* param2 = ast_get_child(type_dseq, 2);
	...
	struct ast_node* type_dret = ast_get_child(etype, 1);
...
void test_parse_anonymous_function2()
{
	...
	struct ast_node* type_return = ast_get_child(type_dret, 0);
...
void test_parse_not_id()
{
	...
	struct ast_node* not = ast_get_child(root, 1);
	assert_ptr(not, "ptr not");
	expect_int_equal(not->type, ast_type_not, "not not");

	struct ast_node* id = ast_get_child(not, 0);
	assert_ptr(id, "ptr id");
	expect_int_equal(id->type, ast_type_id, "id id");
...
void test_parse_not_literal()
{
	...
	struct ast_node* not = ast_get_child(root, 0);
	assert_ptr(not, "ptr not");
	expect_int_equal(not->type, ast_type_not, "not not");

	struct ast_node* lit_bool = ast_get_child(not, 0);
...
void test_parse_array_literal_integer()
{
	...
	struct ast_node* type_vector = ast_get_child(etype, 0);
	...
	struct ast_node* type_element = ast_get_child(etype, 1);
...
void test_parse_paren_num()
{
	...
	struct ast_node* number = ast_get_child(paren, 0);
	expect_int_equal(number->type, ast_type_number, "number number");
