...
void test_comp_table_include()
{
	...
	bool valid_base = comp_unit_compile(cu_base, string_getchar, &sd_base);
	...
	malloc_safe(&cu_main, sizeof(struct comp_unit));
	...
	bool valid_main = comp_unit_compile(cu_main, string_getchar, &sd);
