...
AKELA_API Ake_ast* parse_dseq(
        ...
        bool is_extern,
        bool is_method);
AKELA_API void declare_params(struct Ake_parse_state* ps, Ake_ast* proto, Ake_ast* struct_type);
AKELA_API Ake_ast* parse_declaration(
    struct Ake_parse_state* ps,
    bool add_symbol,
    bool is_method,
    bool require_param_name);
AKELA_API Ake_ast* parse_type(struct Ake_parse_state* ps);
...
AKELA_API bool check_lvalue(struct Ake_parse_state* ps, Ake_ast* n, struct location* loc);
