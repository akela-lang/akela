...
AKELA_API void Ake_get_function_children(Type_use* func, Type_use** inputs, Type_use** outputs);
AKELA_API Type_use* Ake_proto2type_use(struct Ake_symbol_table* st, Ake_ast* proto, Ake_ast* struct_type);
AKELA_API Type_use* Ake_get_function_input_type(Type_use* func, int index);
AKELA_API bool Ake_check_input_type(
        struct Ake_parse_state* ps,
        Type_use* func,
        int index,
        Ake_ast* a);
AKELA_API void Ake_Override_rhs(Type_use* tu, Ake_ast* rhs);
