...
void AkeUnit_parse_assign(Zinc_test* test)
{
	...
	Zinc_assert_int_equal(test, assign->type, Ake_ast_type_assign, "assign");
...
void AkeUnit_parse_assign2(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, right2, "right");
...
void AkeUnit_parse_stmts(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, cu.root, "ptr1");
	...
	Zinc_assert_ptr(test, left3, "left3");
	...
	Zinc_assert_ptr(test, right3, "right3");
...
void AkeUnit_parse_stmts2(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, cu.root, "cu.root");
	Zinc_expect_int_equal(test, cu.root->type, Ake_ast_type_stmts, "parse_stmts");
...
void AkeUnit_parse_if(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, if_node, "ptr cu.root");
...
void AkeUnit_parse_elseif(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, cb2, "ptr cb2");
	...
	Zinc_assert_ptr(test, num3, "ptr num3");
...
void AkeUnit_parse_elseif2(Zinc_test* test)
{
	...
	Ake_ast* if_stmt = Ast_node_get(cu.root, 2);
	Zinc_assert_ptr(test, if_stmt, "ptr cu.root");
	Zinc_expect_int_equal(test, if_stmt->type, Ake_ast_type_if, "if if_stmt");
	...
	Zinc_assert_ptr(test, cb3, "ptr cb3");
	...
	Zinc_assert_ptr(test, y2, "ptr y2");
...
void AkeUnit_parse_else(Zinc_test* test)
{
	...
	Ake_ast* if_stmt = Ast_node_get(cu.root, 2);
	Zinc_assert_ptr(test, if_stmt, "ptr if_stmt");
	Zinc_assert_int_equal(test, if_stmt->type, Ake_ast_type_if, "if if_stmt");

	Ake_ast* cb0 = Ast_node_get(if_stmt, 0);
	Zinc_assert_ptr(test, cb0, "ptr cb0");
...
void AkeUnit_parse_else2(Zinc_test* test)
{
	...
	Ake_ast* if_stmt = Ast_node_get(cu.root, 2);
	Zinc_assert_ptr(test, if_stmt, "ptr cu.root");
	Zinc_assert_int_equal(test, if_stmt->type, Ake_ast_type_if, "if");
	...
	Zinc_assert_ptr(test, cond1, "ptr cond");
...
void AkeUnit_parse_while(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, node, "ptr node");
...
void AkeUnit_parse_for_range(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, dec, "ptr dec");
	...
	Zinc_assert_ptr(test, start, "ptr start");
	...
	Zinc_assert_ptr(test, end, "ptr end");
	...
	Zinc_assert_ptr(test, stmt0, "ptr stmt0");
...
void AkeUnit_parse_for_iteration(Zinc_test* test)
{
	...
	Zinc_assert_ptr(test, i_type_node, "ptr i_tu");

    Ake_type_use* i_tu = i_type_node->tu;
    Zinc_assert_ptr(test, i_tu, "ptr i_tu");

	struct Ake_type_def* i_td = i_tu->td;
	Zinc_assert_ptr(test, i_td, "ptr i_td");
	...
	Zinc_assert_ptr(test, expr, "ptr expr");
	...
	Zinc_assert_ptr(test, stmts0, "ptr stmts0");
	Zinc_expect_int_equal(test, stmts0->type, Ake_ast_type_stmts, "parse_stmts stmts0");
...
void AkeUnit_parse_const(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, const_, "ptr let");
...
void AkeUnit_parse_let3(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, id0, "ptr id0");
...
void AkeUnit_parse_extern(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, fid, "ptr fid");
...
void AkeUnit_parse_stmts_mut(Zinc_test* test) {
    ...
    Zinc_assert_ptr(test, let_lhs, "ptr lhs");
    ...
    Zinc_assert_ptr(test, assign->tu, "ptr assign->tu");
