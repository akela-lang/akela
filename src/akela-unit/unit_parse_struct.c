...
void AkeUnit_parse_struct_field_assign(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, d2, "ptr d2");
    ...
    Zinc_assert_ptr(test, var, "ptr let");
...
void AkeUnit_parse_struct_let_literal(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, expr0, "ptr expr0");
    ...
    Zinc_assert_ptr(test, field1, "ptr field1");
    ...
    Zinc_assert_ptr(test, expr1, "ptr expr1");
    ...
    Zinc_assert_ptr(test, field2, "ptr field2");
    ...
    Zinc_assert_ptr(test, expr2, "ptr expr2");
