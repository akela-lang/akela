...
void AkeUnit_parse_blank(Zinc_test* test)
{
    ...
    Zinc_assert_no_errors(test, pr.errors);

    Zinc_assert_ptr(test, pr.root, "ptr cu.root");
...
void AkeUnit_parse_add(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, pr.root, "ptr cu.root");
    Zinc_assert_int_equal(test, pr.root->type, Ake_ast_type_stmts, "parse_stmts cu.root");

    Ake_ast* add = Ast_node_get(pr.root, 1);
    Zinc_assert_ptr(test, add, "ptr add");
...
void AkeUnit_parse_add_mixed_types(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, add_tu, "ptr add_tu");

    struct Ake_type_def* add_td = add_tu->td;
    Zinc_assert_ptr(test, add_td, "ptr add_td");
    Zinc_expect_int_equal(test, add_td->type, Ake_type_float, "float add_td");
    Zinc_expect_string(test, &add_td->name, "Real64", "Real64 add_td");
...
void AkeUnit_parse_sub(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, sub, "ptr sub");
...
void AkeUnit_parse_sub_positive(Zinc_test* test)
{
    ...
    Ake_ast* sub = Ast_node_get(cu.root, 1);
    Zinc_assert_ptr(test, sub, "cu.root");
    Zinc_expect_int_equal(test, sub->type, Ake_ast_type_minus, "minus sub");
...
void AkeUnit_parse_mult(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, mult, "cu.root");
...
void AkeUnit_parse_mult_positive(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, mult, "ptr mult");
    Zinc_expect_int_equal(test, mult->type, Ake_ast_type_mult, "mult mult");
...
void AkeUnit_parse_divide(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, divide, "ptr divide");
    Zinc_assert_int_equal(test, divide->type, Ake_ast_type_divide, "divide divide");
...
void AkeUnit_parse_add_add(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, plus0, "ptr plus0");
    Zinc_assert_int_equal(test, plus0->type, Ake_ast_type_plus, "plus plus0");

    Ake_ast* left = Ast_node_get(plus0, 0);
    Zinc_assert_ptr(test, left, "ptr left");
    Zinc_expect_int_equal(test, left->type, Ake_ast_type_plus, "plus left");

    Ake_ast* left2 = Ast_node_get(left, 0);
    Zinc_assert_ptr(test, left2, "ptr left2");
    ...
    Zinc_assert_ptr(test, right, "ptr right");
    ...
    Zinc_assert_ptr(test, right2, "ptr right2");
...
void AkeUnit_parse_mult_mult(Zinc_test* test)
{
    ...
    Ake_ast* mult = Ast_node_get(cu.root, 0);
    Zinc_assert_ptr(test, mult, "ptr mult");
    Zinc_assert_int_equal(test, mult->type, Ake_ast_type_mult, "mult mult");
...
void AkeUnit_parse_add_mult(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, plus, "cu.root");
    Zinc_assert_int_equal(test, plus->type, Ake_ast_type_plus, "plus");
...
void AkeUnit_parse_mult_add(Zinc_test* test)
{
    ...
    Zinc_assert_int_equal(test, plus->type, Ake_ast_type_plus, "plus plus");
...
void AkeUnit_parse_power(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, pow, "ptr pow");
    ...
    Zinc_assert_ptr(test, number0, "ptr number0");
    ...
    Zinc_assert_ptr(test, number1, "ptr number1");
...
void AkeUnit_parse_paren_add_add(Zinc_test* test)
{
    ...
    Ake_ast* left2 = Ast_node_get(right, 0);
    Zinc_assert_ptr(test, left2, "right");
    Zinc_expect_int_equal(test, left2->type, Ake_ast_type_number, "number 2");
...
void AkeUnit_parse_paren_mult_mult(Zinc_test* test)
{
    ...
    Ake_ast* left2 = Ast_node_get(right, 0);
    Zinc_assert_ptr(test, left2, "left 2");
    Zinc_expect_int_equal(test, left2->type, Ake_ast_type_number, "number 2");
    Zinc_expect_string(test, &left2->value, "2", "2");
...
void AkeUnit_parse_comparison(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, right0, "ptr right0");
    ...
    Zinc_assert_ptr(test, cond1, "ptr cond1");
    Zinc_expect_int_equal(test, cond1->type, Ake_ast_type_not_equal, "not equal cond1");

    Ake_type_use* cond1_tu = cond1->tu;
    Zinc_assert_ptr(test, cond1_tu, "ptr cond1_tu");

    struct Ake_type_def* cond1_td = cond1_tu->td;
    Zinc_assert_ptr(test, cond1_td, "ptr cond0_td");
    Zinc_expect_int_equal(test, cond1_td->type, Ake_type_float, "float cond1_td");
    Zinc_expect_string(test, &cond1_td->name, "Real64", "Real64 cond1_td");

    Ake_ast* left1 = Ast_node_get(cond1, 0);
    Zinc_assert_ptr(test, left1, "ptr left1");
    ...
    Zinc_assert_ptr(test, right1, "ptr right1");
    ...
    Zinc_assert_ptr(test, cond2, "ptr cond2");
    ...
    Zinc_assert_ptr(test, cond3, "ptr cond3");
    ...
    Zinc_assert_ptr(test, left3, "ptr left3");
    ...
    Zinc_assert_ptr(test, right3, "ptr right3");
...
void AkeUnit_parse_comparison_identity(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, comp0, "ptr comp0");
    Zinc_assert_ptr(test, comp0->tu, "ptr comp0->tu");
    Zinc_assert_ptr(test, comp0->tu->td, "ptr comp0->tu->td");
    Zinc_expect_int_equal(test, comp0->tu->td->type, Ake_type_boolean, "boolean comp0->tu->td->type");
    Zinc_expect_string(test, &comp0->tu->td->name, "Bool", "Bool comp0->tu->td->name");

    Ake_ast* comp1 = Ast_node_get(cu.root, 1);
    Zinc_assert_ptr(test, comp1, "ptr comp1");
    Zinc_assert_ptr(test, comp1->tu, "ptr comp->tu1");
    Zinc_assert_ptr(test, comp1->tu->td, "ptr comp1->tu->td");
    Zinc_expect_int_equal(test, comp1->tu->td->type, Ake_type_boolean, "boolean comp1->tu->td->type");
...
void AkeUnit_parse_and(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, and, "ptr and");
...
void AkeUnit_parse_or(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, or, "ptr or");
...
void AkeUnit_parse_array_subscript(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, as, "ptr as");
    ...
    Zinc_assert_ptr(test, index, "ptr index");
...
void AkeUnit_parse_array_subscript2(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, a, "ptr a");
    Zinc_assert_int_equal(test, a->type, Ake_ast_type_array_subscript, "array-subscript a");

    Ake_type_use* a_tu = a->tu;
    Zinc_assert_ptr(test, a_tu, "ptr tu");
...
void AkeUnit_parse_expr_array_subscript_3d(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, const_, "per const_");
    Zinc_expect_int_equal(test, const_->type, Ake_ast_type_const, "type const_");

    Ake_ast* const_type = Ast_node_get(const_, 1);
    Zinc_assert_ptr(test, const_type, "ptr const_type");
    Zinc_expect_int_equal(test, const_type->type, Ake_ast_type_type, "type const_type");

    Ake_ast* a = Ast_node_get(cu.root, 1);
    Zinc_assert_ptr(test, a, "ptr a");
    Zinc_assert_int_equal(test, a->type, Ake_ast_type_array_subscript, "type a");

    Ake_type_use* a_tu = a->tu;
    Zinc_assert_ptr(test, a_tu, "ptr a_tu");
    ...
    Zinc_assert_ptr(test, a_td, "ptr a_td");
    Zinc_expect_int_equal(test, a_td->type, Ake_type_integer, "type a_td");
    ...
    Zinc_assert_ptr(test, b_tu, "ptr b_tu");
    ...
    Zinc_assert_ptr(test, b_dim0, "ptr b_dim0");
    ...
    Zinc_assert_ptr(test, c_tu, "ptr c_tu");
    ...
    Zinc_assert_ptr(test, c_dim0, "ptr c_dim0");
    ...
    Zinc_assert_ptr(test, c_dim1, "ptr c_dim1");
    ...
    Zinc_assert_ptr(test, d_tu, "ptr d_tu");
    ...
    Zinc_assert_ptr(test, d_dim0, "ptr d_dim0");
    ...
    Zinc_assert_ptr(test, d_dim1, "ptr d_dim1");
    ...
    Zinc_assert_ptr(test, d_dim2, "ptr d_dim2");
...
void AkeUnit_parse_assign_string(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, lhv, "ptr lhv");
    ...
    Zinc_assert_ptr(test, rhv, "ptr rhv");
...
void AkeUnit_parse_assign_multiple(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, assign_tu, "ptr assign_tu");

    struct Ake_type_def* assign_td = assign_tu->td;
    Zinc_assert_ptr(test, assign_td, "ptr assign_td");
    Zinc_expect_int_equal(test, assign_td->type, Ake_type_integer, "integer assign_td");
    Zinc_expect_string(test, &assign_td->name, "Int32", "Int32 assign_td");

    Ake_ast* assign0 = Ast_node_get(assign, 0);
    Zinc_assert_ptr(test, assign0, "ptr lhv0");
    ...
    Zinc_assert_ptr(test, assign1, "ptr assign1");
    ...
    Zinc_assert_ptr(test, assign2, "ptr assign2");
    ...
    Zinc_assert_ptr(test, assign3, "ptr assign3");
...
void AkeUnit_parse_expr_newline_boolean(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, op, "ptr add");
...
void AkeUnit_parse_expr_newline_subscript(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, subscript, "ptr subscript");
    ...
    Zinc_assert_ptr(test, array, "array");
    ...
    Zinc_assert_ptr(test, zero, "zero");
...
void AkeUnit_parse_expr_newline_function_call(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, cseq, "ptr cseq");
...
void AkeUnit_parse_expr_assign_eseq(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, lvalue, "ptr lvalue");
