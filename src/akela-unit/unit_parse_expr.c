...
void AkeUnit_parse_add(Zinc_test* test)
{
    ...
    if (!Zinc_expect_int_equal(test, pr.root->kind, Ake_ast_type_stmts, "parse_stmts cu.root")) {
		return Zinc_assert();
	}
    ...
    Ake_Type* tu = add->type;
    if (!Zinc_expect_ptr(test, tu, "ptr tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, tu->kind, AKE_TYPE_INTEGER, "integer td");
...
void AkeUnit_parse_add_mixed_types(Zinc_test* test)
{
    ...
    Ake_Type* add_tu = add->type;
    if (!Zinc_expect_ptr(test, add_tu, "ptr add_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, add_tu->kind, AKE_TYPE_INTEGER, "kind add_td");
...
void AkeUnit_parse_add_positive(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, right->kind, Ake_ast_type_sign, "sign");
    ...
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_plus, "plus2");
...
void AkeUnit_parse_add_negative(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_minus, "minus");
...
void AkeUnit_parse_sub_positive(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_plus, "plus");
...
void AkeUnit_parse_sub_negative(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_minus, "minus2");
...
void AkeUnit_parse_divide(Zinc_test* test)
{
    ...
    if (!Zinc_expect_int_equal(test, divide->kind, Ake_ast_type_divide, "divide divide")) {
		return Zinc_assert();
	}
...
void AkeUnit_parse_add_add(Zinc_test* test)
{
    ...
    if (!Zinc_expect_int_equal(test, plus0->kind, Ake_ast_type_plus, "plus plus0")) {
		return Zinc_assert();
	}
    ...
    Zinc_expect_int_equal(test, left->kind, Ake_ast_type_plus, "plus left");

    Ake_Ast* left2 = Ast_node_get(left, 0);
    if (!Zinc_expect_ptr(test, left2, "ptr left2")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_number, "number left2");
    ...
    Zinc_expect_int_equal(test, right->kind, Ake_ast_type_number, "number right");
...
void AkeUnit_parse_mult_mult(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, left->kind, Ake_ast_type_mult, "mult left");
...
void AkeUnit_parse_add_mult(Zinc_test* test)
{
    ...
    if (!Zinc_expect_int_equal(test, plus->kind, Ake_ast_type_plus, "plus")) {
		return Zinc_assert();
	}
    ...
    Zinc_expect_int_equal(test, right->kind, Ake_ast_type_mult, "mult");
...
void AkeUnit_parse_mult_add(Zinc_test* test)
{
    ...
    if (!Zinc_expect_int_equal(test, plus->kind, Ake_ast_type_plus, "plus plus")) {
		return Zinc_assert();
	}
    ...
    Zinc_expect_int_equal(test, left->kind, Ake_ast_type_mult, "mult");

    Ake_Ast* left2 = Ast_node_get(left, 0);
    if (!Zinc_expect_ptr(test, left2, "left2")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, left2->kind, Ake_ast_type_number, "number 4");
...
void AkeUnit_parse_paren_add_add(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, right->kind, Ake_ast_type_plus, "plus 2");
...
void AkeUnit_parse_paren_add_add2(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, left->kind, Ake_ast_type_plus, "plus 2");
...
void AkeUnit_parse_comparison(Zinc_test* test)
{
    ...
    Ake_Type* cond0_tu = cond0->type;
    if (!Zinc_expect_ptr(test, cond0_tu, "ptr cond0_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, cond0_tu->kind, AKE_TYPE_INTEGER, "integer cond0_tu");
    ...
    Ake_Type* cond1_tu = cond1->type;
    if (!Zinc_expect_ptr(test, cond1_tu, "ptr cond1_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, cond1_tu->kind, AKE_TYPE_INTEGER, "kind cond1_td");
...
void AkeUnit_parse_or(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, tu->kind, AKE_TYPE_BOOLEAN, "boolean tu");
...
void AkeUnit_parse_array_subscript2(Zinc_test* test)
{
    ...
    Ake_Type* a_tu = a->type;
    if (!Zinc_expect_ptr(test, a_tu, "ptr tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, a_tu->kind, AKE_TYPE_INTEGER, "type a_tu");
...
void AkeUnit_parse_array_subscript3(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, tu->kind, AKE_TYPE_INTEGER, "integer tu");
...
void AkeUnit_parse_expr_array_subscript_3d(Zinc_test* test)
{
    ...
    Zinc_expect_int_equal(test, a_tu->kind, AKE_TYPE_INTEGER, "kind a_tu");
    ...
    Ake_Type* b_tu = b->type;
    if (!Zinc_expect_ptr(test, b_tu, "ptr b_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, b_tu->kind, AKE_TYPE_ARRAY_CONST, "kind b_tu");
    ...
    Ake_Type* c_tu = c->type;
    if (!Zinc_expect_ptr(test, c_tu, "ptr c_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_true(test, c_tu->kind == AKE_TYPE_ARRAY, "is_mut c_tu");
    ...
    Ake_Type* d_tu = d->type;
    if (!Zinc_expect_ptr(test, d_tu, "ptr d_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_true(test, d_tu->kind == AKE_TYPE_ARRAY, "is_mut d_tu");
...
void AkeUnit_parse_assign_string(Zinc_test* test)
{
    ...
    Ake_Type* tu = assign->type;
    if (!Zinc_expect_ptr(test, tu, "ptr tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, tu->kind, AKE_TYPE_ARRAY_CONST, "type tu");
    Zinc_expect_uint8_t_equal(test, tu->data.array_const.dim, 6, "dim tu");

	Ake_Type* tu2 = tu->data.array_const.td;
	if (!Zinc_expect_ptr(test, tu2, "ptr tu2")) {
		return Zinc_assert();
	}
	Zinc_expect_int_equal(test, tu2->kind, AKE_TYPE_NATURAL, "kind tu2");
...
void AkeUnit_parse_assign_multiple(Zinc_test* test)
{
    ...
    Ake_Type* assign_tu = assign->type;
    if (!Zinc_expect_ptr(test, assign_tu, "ptr assign_tu")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, assign_tu->kind, AKE_TYPE_INTEGER, "integer assign_td");
