...
void test_parse_array_subscript2()
{
    ...
    Zinc_assert_ptr(c, "ptr c");
    Zinc_expect_int_equal(c->type, Ake_ast_type_id, "id c");
    Zinc_expect_string(&c->value, "a", "value a");
...
void test_parse_expr_array_subscript_3d()
{
    ...
    Zinc_assert_ptr(const_, "per const_");
    Zinc_expect_int_equal(const_->type, Ake_ast_type_const, "type const_");

    Ake_ast* const_type = Ast_node_get(const_, 1);
    Zinc_assert_ptr(const_type, "ptr const_type");
    Zinc_expect_int_equal(const_type->type, Ake_ast_type_type, "type const_type");
    ...
    Zinc_expect_string(&a_td->name, "Int32", "name a_td");
...
void test_parse_assign_multiple()
{
    ...
    Zinc_expect_string(&assign2->value, "c", "assign2 value");
...
void test_parse_expr_newline_assignment()
{
    ...
    Zinc_expect_string(&one->value, "a", "a one");
...
void test_parse_expr_newline_boolean()
{
    ...
    Zinc_expect_string(&one->value, "true", "true");
...
void test_parse_expr_newline_subscript()
{
    ...
    Zinc_expect_string(&array->value, "a", "a");
...
void test_parse_expr_newline_function_call()
{
    ...
    Zinc_expect_string(&foo->value, "foo", "foo");
