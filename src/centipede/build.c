...
void Cent_build_object_method_child_of(Cent_build_data* bd, Cent_ast* n, Cent_value* value);
void Cent_build_object_method_property_of(Cent_build_data* bd, Cent_ast* n, Cent_value* value);
