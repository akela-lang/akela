    ...
    void Check_subscript(Jit_data* jd, Ake_Ast* n)
    {
        ...
        switch (n->kind) {
            ...
            case AKE_AST_GREATER_THAN_OR_EQUAL:
                Check_subscript(jd, n->data.greater_than_or_equal.left);
                Check_subscript(jd, n->data.greater_than_or_equal.right);
                break;
            case AKE_AST_NOT:
                Check_subscript(jd, n->data._not_.right);
                break;
            case AKE_AST_AND:
            ...
            case AKE_AST_FOR_RANGE:
                Check_subscript(jd, n->data.for_range.dec);
                Check_subscript(jd, n->data.for_range.start);
            ...
            case AKE_AST_POWER:
                ...
                break;
            case AKE_AST_DOT:
                Check_subscript(jd, n->data.dot.left);
                Check_subscript(jd, n->data.dot.right);
                break;
            case AKE_AST_STRUCT:
