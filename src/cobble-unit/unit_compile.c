...
void CobUnit_compile_literal(Zinc_test* test)
{
    ...
    Zinc_expect_no_errors(test, re.errors);
    Zinc_assert_ptr(test, re.root, "ptr root");
...
void CobUnit_compile_union_concat(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, ab, "ptr ab");
    ...
    Zinc_assert_ptr(test, _cd, "ptr _cd");
...
void CobUnit_compile_closure(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, lit, "ptr lit");
...
void CobUnit_compile_concat_closure(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, c0, "ptr c0");
    ...
    Zinc_assert_ptr(test, c1, "ptr c1");
...
void CobUnit_compile_group_concat(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, gr, "ptr gr");
    ...
    Zinc_assert_ptr(test, un, "ptr group");
...
void CobUnit_compile_character_class(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, c2, "ptr c2");
...
void CobUnit_compile_character_range(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, c00, "ptr c00");
    ...
    Zinc_assert_ptr(test, c01, "ptr c01");
...
void CobUnit_compile_coverage_line(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, space0, "ptr space0");
    ...
    Zinc_assert_ptr(test, space00, "ptr space00");
    ...
    Zinc_assert_ptr(test, group0, "ptr group0");
    ...
    Zinc_assert_ptr(test, escape0, "ptr escape0");
    ...
    Zinc_assert_ptr(test, colon0, "ptr colon0");
    ...
    Zinc_assert_ptr(test, space1, "ptr space1");
    ...
    Zinc_assert_ptr(test, space10, "ptr space10");
    ...
    Zinc_assert_ptr(test, group1, "ptr group1");
    ...
    Zinc_assert_ptr(test, digit0, "ptr digit0");
    ...
    Zinc_assert_ptr(test, digit01, "ptr digit01");
    ...
    Zinc_assert_ptr(test, colon1, "ptr colon1");
    ...
    Zinc_assert_ptr(test, lit0, "ptr lit0");
    ...
    Zinc_assert_ptr(test, lit1, "ptr lit1");
    ...
    Zinc_assert_ptr(test, lit2, "ptr lit2");
    ...
    Zinc_assert_ptr(test, lit3, "ptr lit3");
    ...
    Zinc_assert_ptr(test, lit4, "ptr lit4");
    ...
    Zinc_assert_ptr(test, lit5, "ptr lit5");
    ...
    Zinc_assert_ptr(test, colon2, "ptr colon2");
    ...
    Zinc_assert_ptr(test, group2, "ptr group2");
    ...
    Zinc_assert_ptr(test, pc1, "ptr pc1");
    ...
    Zinc_assert_ptr(test, wc0, "ptr wc0");
...
void CobUnit_compile_coverage_line2(Zinc_test* test)
{
    ...
    Zinc_assert_ptr(test, option0, "ptr option0");
    ...
    Zinc_assert_ptr(test, concat1, "ptr concat1");
    ...
    Zinc_assert_ptr(test, group3, "ptr group3");
