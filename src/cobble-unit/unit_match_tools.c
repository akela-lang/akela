...
void CobUnit_match_tools_match_task_stack(Zinc_test* test)
{
    if (test->dry_run) {
...
void CobUnit_match_tools_stack_list_remove_middle(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_stack_list_remove_head(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_stack_list_remove_tail(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_stack_list_remove_single(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_clone(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_stack_node_clone(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools_stack_priority(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
...
void CobUnit_match_tools(Zinc_test* test)
{
    if (test->dry_run) {
        Zinc_string_add_str(&test->name, __func__);
        test->mute = false;
        ...
        Zinc_test_register(test, CobUnit_match_tools_match_task_stack);
        Zinc_test_register(test, CobUnit_match_tools_stack_list_remove_middle);
        Zinc_test_register(test, CobUnit_match_tools_stack_list_remove_head);
        Zinc_test_register(test, CobUnit_match_tools_stack_list_remove_tail);
        Zinc_test_register(test, CobUnit_match_tools_stack_list_remove_single);
        Zinc_test_register(test, CobUnit_match_tools_clone);
        Zinc_test_register(test, CobUnit_match_tools_stack_node_clone);
        Zinc_test_register(test, CobUnit_match_tools_stack_priority);
