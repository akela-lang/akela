...
void CentUnit_parse_element(Zinc_test* test)
{
    ...
    /* root */
    if (!Zinc_expect_ptr(test, root, "ptr pr.root")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, element, "ptr element")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, prop, "ptr prop")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, type0, "ptr type0")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, mod0, "ptr mod0")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, type1, "ptr type1")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, children, "ptr children")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, test_node, "ptr test")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_enumerate(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, enumerate, "ptr enumerate")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, value2, "ptr value2")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_top_level_assignment(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, enum_type, "ptr enum_type")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, object, "ptr object")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, type_prop_set, "ptr type_prop_set")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, ns, "ptr ns")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, enum_id, "ptr enum_id")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, enum_value_id, "ptr enum_value_id")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, name_prop_set, "ptr name_prop_set")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, name1, "ptr type")) {
		return Zinc_assert();
	}
    Zinc_expect_int_equal(test, name1->type, Cent_ast_type_id, "type name1");
    ...
    if (!Zinc_expect_ptr(test, name_value, "ptr name_value")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, bit_count_prop_set, "ptr bit_count_prop_set")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, bit_count, "ptr bit_count")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, bit_count_value, "ptr bit_count_value")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, is_signed_prop_set, "ptr is_signed_prop_set")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, is_signed, "ptr is_signed")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, is_signed_value, "ptr is_signed_value")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_include(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, use, "ptr use")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, types, "ptr types")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, grocery_item, "ptr grocery_item")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, milk, "ptr milk")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_include_multiple_namespace(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, lib_mod, "ptr lib_mod")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, types_mod, "ptr types_mod")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, lib, "ptr lib")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_include_value(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, data_mod, "ptr data_mod")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, data, "ptr data")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_const(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, variable, "ptr variable")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_element_tagged(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, enum_, "ptr enum_")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, item1, "ptr item1")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, item2, "ptr item2")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, item3, "ptr item3")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car, "ptr car")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_var_set, "ptr car_var_set")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_tag, "ptr car_tag")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_tag_name, "ptr car_tag_name")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_tag_ns, "ptr car_tag_ns")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_tag_ns_id1, "ptr car_tag_ns_id1")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, car_tag_ns_id2, "ptr car_tag_ns_id2")) {
		return Zinc_assert();
	}
...
void CentUnit_parse_variant(Zinc_test* test)
{
    ...
    if (!Zinc_expect_ptr(test, variant, "ptr variant")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, vns, "ptr vns")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, el, "ptr el")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, kind, "ptr kind")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, vnt_properties, "ptr vnt_properties")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, siphon_prop, "ptr siphon_prop")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, siphon_id, "ptr siphon")) {
		return Zinc_assert();
	}
    ...
    if (!Zinc_expect_ptr(test, siphon_type, "ptr siphon_type")) {
		return Zinc_assert();
	}
