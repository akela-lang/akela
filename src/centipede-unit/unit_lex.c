...
void CentUnit_lex_element(Zinc_test* test)
{
    ...
    /* line 3 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 3.1");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 3.2");
    Zinc_expect_int_equal(test, t->type, Cent_token_colon, "type 3.2");
    Cent_token_destroy(t);
    free(t);

    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 3.3");
    ...
    /* line 5 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 5.1");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 5.2");
    Zinc_expect_int_equal(test, t->type, Cent_token_colon, "type 5.2");
    Cent_token_destroy(t);
    free(t);

    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 5.3");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 5.4");
    ...
    /* line 6 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 6.1");
    ...
    /* line 8 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 8.1");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 8.2");
    ...
    /* line 9 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 9.1");
    ...
    /* line 10 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 10.1");
...
void CentUnit_lex_enum(Zinc_test* test)
{
    ...
    /* line 4 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 4.1");
    Zinc_expect_int_equal(test, t->type, Cent_token_id, "type 4.1");
...
void CentUnit_lex_top_level_assign(Zinc_test* test)
{
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 3.6");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 4.2");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 4.3");
    Zinc_expect_int_equal(test, t->type, Cent_token_equal, "type 4.3");
    Cent_token_destroy(t);
    free(t);

    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 4.4");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 6.2");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 6.3");
    Zinc_expect_int_equal(test, t->type, Cent_token_equal, "type 6.3");
    Cent_token_destroy(t);
    free(t);

    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 6.4");
    ...
    /* eof */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr eof");
...
void CentUnit_lex_builtin(Zinc_test* test)
{
    ...
    /* line 1 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 1.1");
    ...
    /* line 2 */
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 2.1");
    Zinc_expect_int_equal(test, t->type, Cent_token_id, "type 2.1");
...
void CentUnit_lex_escape_backslash(Zinc_test* test)
{
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 1.2");
...
void CentUnit_lex_semicolon(Zinc_test* test)
{
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 1.3");
    ...
    t = lex(&ld);
    Zinc_assert_ptr(test, t, "ptr 1.6");
