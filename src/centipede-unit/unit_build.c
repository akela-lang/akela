...
void CentUnit_build_number_integer(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_natural, "type root");
    Zinc_test_expect_uint64_t_equal(test, root->data.natural, 241, "integer root");
...
void CentUnit_build_number_fp(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_real, "type root");
    Zinc_test_expect_double_equal(test, root->data.real, 1.5, "fp root");
...
void CentUnit_build_string(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_string, "type root");
    Zinc_test_expect_string(test, &root->data.string, "hello", "string root");
...
void CentUnit_build_boolean_true(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_boolean, "type root");
    Zinc_test_expect_true(test, root->data.boolean, "string root");
...
void CentUnit_build_boolean_false(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_boolean, "type root");
    Zinc_test_expect_false(test, root->data.boolean, "string root");
...
void CentUnit_build_enum0(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_enum, "type root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_type->name, "Symbol_type", "id1 root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_value->display, "Variable", "id2 root");
    Zinc_test_expect_size_t_equal(test, root->data.enumeration.number, 0, "enumeration number root");
...
void CentUnit_build_enum1(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_enum, "type root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_type->name, "Symbol_type", "id1 root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_value->display, "Type", "id2 root");
    Zinc_test_expect_size_t_equal(test, root->data.enumeration.number, 1, "enumeration number root");
...
void CentUnit_build_enum2(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_enum, "type root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_type->name, "Symbol_type", "id1 root");
    Zinc_test_expect_string(test, &root->data.enumeration.enum_value->display, "Info", "id2 root");
    Zinc_test_expect_size_t_equal(test, root->data.enumeration.number, 2, "enumeration number root");
...
void CentUnit_build_assign(Zinc_test* test)
{
    ...
    Zinc_test_expect_ptr(test, root, "ptr");

    Cent_environment* top = Cent_get_environment(ct->primary->pr.root);
    Zinc_test_assert_ptr(test, top, "ptr top");

    Cent_symbol* sym = Cent_environment_get_str(top, "a");
    Zinc_test_assert_ptr(test, sym, "ptr sym");
    Zinc_test_expect_int_equal(test, sym->type, Cent_symbol_type_variable, "type sym");

    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_natural, "type number");
    Zinc_test_expect_uint64_t_equal(test, root->data.natural, 1, "integer value");
...
void CentUnit_build_object(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr root");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_dag, "type root");
...
void CentUnit_build_object_prop_set(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, a->type, Cent_value_type_natural, "type number");
    Zinc_test_expect_long_long_equal(test, a->data.natural, 1, "integer value");
...
void CentUnit_build_property_set_variable(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_dag, "type root");
    Zinc_test_expect_string(test, &root->name, "Test", "name root");

    Cent_value* source = Cent_value_get_str(root, "source");
    Zinc_test_assert_ptr(test, source, "ptr source");
    Zinc_test_expect_int_equal(test, source->type, Cent_value_type_dag, "type source");
    Zinc_test_expect_string(test, &source->name, "Source", "name source");

    Cent_value* line0 = source->data.dag.head;
    Zinc_test_assert_ptr(test, line0, "ptr line0");
    Zinc_test_expect_int_equal(test, line0->type, Cent_value_type_string, "type line0");
    Zinc_test_expect_string(test, &line0->name, "String", "name line0");
    Zinc_test_expect_string(test, &line0->data.string, "x + 5", "string line0");
...
void CentUnit_build_namespace_enum(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_dag, "type root");
    Zinc_test_expect_string(test, &root->name, "Groceries", "name root");

    Cent_value* item0 = root->data.dag.head;
    Zinc_test_assert_ptr(test, item0, "ptr item0");
    Zinc_test_expect_int_equal(test, item0->type, Cent_value_type_enum, "type item0");
    Zinc_test_expect_size_t_equal(test, item0->data.enumeration.number, 0, "number item0");

    Cent_value* item1 = item0->next;
    Zinc_test_assert_ptr(test, item0, "ptr item1");
    Zinc_test_expect_int_equal(test, item1->type, Cent_value_type_enum, "type item1");
    Zinc_test_expect_size_t_equal(test, item1->data.enumeration.number, 4, "number item1");
...
void CentUnit_build_namespace_variable(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, a, "ptr a2");

    Cent_value* b = a->next;
    Zinc_test_assert_ptr(test, b, "ptr a2");

    Cent_value* c = b->next;
    Zinc_test_assert_ptr(test, c, "ptr a2");

    Cent_value* a2 = c->next;
    Zinc_test_assert_ptr(test, a2, "ptr a2");
    Zinc_test_expect_int_equal(test, a2->type, Cent_value_type_natural, "type a2");
    Zinc_test_expect_uint64_t_equal(test, a2->data.natural, 9, "integer a2");
...
void CentUnit_build_namespace_submodules(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_natural, "type root");
    Zinc_test_expect_uint64_t_equal(test, root->data.natural, 190, "integer root");
...
void CentUnit_build_namespace_glob_value(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_natural, "type root");
    Zinc_test_expect_uint64_t_equal(test, root->data.integer, 190, "integer root");
...
void CentUnit_build_const(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_natural, "type root");
    Zinc_test_expect_uint64_t_equal(test, root->data.natural, 245, "integer root");
...
void CentUnit_build_cast_natural_to_integer(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_dag, "type root");
    Zinc_test_expect_string(test, &root->name, "Foo", "name root");

    Cent_value* x = Cent_value_get_str(root, "x");
    Zinc_test_assert_ptr(test, x, "ptr x");
    Zinc_test_expect_int_equal(test, x->type, Cent_value_type_integer, "type x");
    Zinc_test_expect_string(test, &x->name, "Integer", "name x");
    Zinc_test_expect_int64_t_equal(test, x->data.integer, 100, "integer x");
...
void CentUnit_build_cast_integer_to_natural_error(Zinc_test* test)
{
    ...
    Zinc_test_expect_has_errors(test, errors);
    Zinc_test_expect_source_error(test, errors, "Integer (-100) is negative; cannot cast to Natural");
...
void CentUnit_build_cast_natural_to_real(Zinc_test* test)
{
    ...
    Cent_value* x = Cent_value_get_str(root, "x");
    Zinc_test_assert_ptr(test, x, "ptr x");
    Zinc_test_expect_int_equal(test, x->type, Cent_value_type_real, "type x");
    Zinc_test_expect_string(test, &x->name, "Real", "name x");
    Zinc_test_expect_double_equal(test, x->data.real, 100, "integer x");
...
void CentUnit_build_cast_real_to_natural(Zinc_test* test)
{
    ...
    Cent_value* x = Cent_value_get_str(root, "x");
    Zinc_test_assert_ptr(test, x, "ptr x");
    Zinc_test_expect_int_equal(test, x->type, Cent_value_type_natural, "type x");
    Zinc_test_expect_string(test, &x->name, "Natural", "name x");
    Zinc_test_expect_uint64_t_equal(test, x->data.natural, 100, "integer x");
...
void CentUnit_build_cast_real_to_natural_error_negative(Zinc_test* test)
{
    ...
    Zinc_test_expect_has_errors(test, errors);
    Zinc_test_expect_source_error(test, errors, "Real (-100.000000) is negative; cannot cast to Natural");
...
void CentUnit_build_cast_integer_to_real(Zinc_test* test)
{
    ...
    Zinc_test_expect_int_equal(test, x->type, Cent_value_type_real, "type x");
    Zinc_test_expect_string(test, &x->name, "Real", "name x");
    Zinc_test_expect_double_equal(test, x->data.real, -100.000000, "integer x");
...
void CentUnit_build_variant(Zinc_test* test)
{
    ...
    Zinc_test_assert_ptr(test, root, "ptr value");
    Zinc_test_expect_int_equal(test, root->type, Cent_value_type_dag, "type root");
    Zinc_test_expect_string(test, &root->name, "Monsters", "name root");
...
void CentUnit_build_cycle(Zinc_test* test)
{
    ...
    Cent_value* root = ct->primary->value;
    Zinc_test_expect_has_errors(test, errors);
    Zinc_test_expect_source_error(test, errors, "cycle detected");
