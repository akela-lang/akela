...
void Zinc_unit_input_unicode_file_next(Zinc_test* test)
{
    ...
    Zinc_test_expect_size_t_equal(test, s_len, n, "len");
    fclose(fp);
    fp = fopen(name.buf, "r");
    Zinc_test_assert_ptr(test, fp, "open file");
...
void Zinc_unit_input_unicode_file_next_multibyte(Zinc_test* test)
{
    ...
    Zinc_test_expect_size_t_equal(test, loc.line, 2, "6 line");
    Zinc_test_expect_size_t_equal(test, loc.col, 1, "6 col");
    Zinc_test_expect_size_t_equal(test, loc.end_pos, 8, "6 end_pos");
    ...
    Zinc_test_expect_size_t_equal(test, loc.start_pos, 10, "6 start_pos");
    Zinc_test_expect_size_t_equal(test, loc.line, 2, "8 line");
    Zinc_test_expect_size_t_equal(test, loc.col, 3, "8 col");
...
void Zinc_unit_input_unicode_file_get_all(Zinc_test* test)
{
    ...
    Zinc_test_expect_true(test, Zinc_vector_match_str(output, s), "match");
...
void Zinc_unit_input_unicode_file_get_location(Zinc_test* test)
{
    ...
    Zinc_test_expect_size_t_equal(test, next_loc.end_pos, 1, "1 end_pos");
