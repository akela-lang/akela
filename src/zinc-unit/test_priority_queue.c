...
void test_priority_queue_pop_highest()
{
    Zinc_test_name(__func__);
    ...
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), t60, "pop 0");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), t54, "pop 1");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), t30, "pop 2");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), t22, "pop 3");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), t15, "pop 4");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_highest(pq), NULL, "pop 5");
...
void test_priority_queue_pop_lowest()
{
    Zinc_test_name(__func__);
    ...
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), t15, "pop 0");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), t22, "pop 1");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), t30, "pop 2");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), t54, "pop 3");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), t60, "pop 4");
    Zinc_expect_ptr_equal(Zinc_priority_queue_pop_lowest(pq), NULL, "pop 5");
...
void test_priority_queue()
{
    ...
    test_priority_queue_pop_highest();
    test_priority_queue_pop_lowest();
}