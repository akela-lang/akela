...
void Zinc_unit_os_unix_path_join(Zinc_test* test)
{
    ...
    Zinc_expect_string(test, &c, "/home/alf", "/home/alf");
...
void Zinc_unit_os_unix_get_user_app_directory(Zinc_test* test)
{
    ...
    Zinc_expect_string(test, &dir, "/home/abc/.app/stone", "/home/abc/.app/stone");
...
void Zinc_unit_os_unix_file_exists(Zinc_test* test)
{
    ...
    Zinc_expect_true(test, Zinc_file_exists(Zinc_string_c_str(&filename)), "file exists true");

    system("rm /tmp/test_os_unix_file_exits");
    Zinc_expect_false(test, Zinc_file_exists(Zinc_string_c_str(&filename)), "file exits false");
...
void Zinc_unit_os_unix_get_dir_files(Zinc_test* test)
{
    ...
    Zinc_expect_ok(test, r, "get_dir_files");
    ...
    Zinc_expect_true(test, seen_file1, "seen_file1");
    Zinc_expect_true(test, seen_file2, "seen_file2");
    Zinc_expect_true(test, seen_file3, "seen_file3");
    Zinc_expect_true(test, seen_file4, "seen_file4");
