...
Ast_node* parse_eseq(struct parse_state* ps);
Ast_node* parse_boolean(struct parse_state* ps);
Ast_node* parse_comparison(struct parse_state* ps);
...
Ast_node* parse_simple_expr(struct parse_state* ps)
{
